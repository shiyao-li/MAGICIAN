...
def compute_scone_trajectory(params, macarons, camera, gt_scene, surface_scene, 
...
def run_scone_test(params_name,
             model_name,
             results_json_name,
             numGPU,
             test_scenes,
    ...
    lmdb_dir = os.path.join(results_dir, "scone_lmdb")
    ...
    for i in range(len(dataloader.dataset)):
        ...
        for i_scene in range(batch_size):
            ...
            for start_cam_idx_i in range(len(settings.camera.start_positions)):
                ...
                coverage_evolution, X_cam_history, V_cam_history, full_pc, full_pc_colors, full_pc_idx = compute_scone_trajectory(params, macarons,
                                                                                      camera,
